...
public class PaymentFactory {
    ...
    public static Payment createPayment(double amount, String paymentMethod, String cardName, Long cardNumber, LocalDate expirationDate, String paymentType, Short cvs, User user){
    ...
    // Payment with Cash.
    public static Payment createPayment(double amount, String paymentMethod, String paymentType,User user){
